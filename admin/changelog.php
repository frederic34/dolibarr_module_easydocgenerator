 ...
 * Copyright (C) 2022-2023  Frédéric France         <frederic.france@free.fr>
 *
...
$help_url = '';
$page_name = "EasydocgeneratorChangelog";
...
$display = $tmpmodule->getChangeLog();
$codes = [
	"+1" => "\u{1f44d}",
	"-1" => "\u{1f44e}",
	"100" => "\u{1f4af}",
...
foreach ($codes as $key => $code) {
	$display = str_replace(':' . $key . ':', $code, $display);
}
