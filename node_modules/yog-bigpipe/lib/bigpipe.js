...
BigPipe.prototype.bindPageOnly = function (fn) {
    this.bind('_PAGE_ONLY_', fn);
};
...
BigPipe.prototype.preparePageOnly = function() {
    var sources = this.sources;
    if (sources._PAGE_ONLY_) {
        return sources._PAGE_ONLY_();
    } else {
...
BigPipe.prototype.prepareAllSources = function () {
    ...
    for (var id in sources) {
        if (sources.hasOwnProperty(id) && id !== '_PAGE_ONLY_') {
            // 屏蔽所有异常
