...
/**
 * \file    test/phpunit/EasyBuilderFunctionalTest.php
 * \ingroup easybuilder
...
/**
 * Class EasyBuilderFunctionalTest
 *
 ...
 *
 * @package Testeasybuilder
 */
class EasyBuilderFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modEasyBuilder')->click();
		} else {
			// Disable the module
			$this->byHref('modEasyBuilder')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/easybuilder/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('easybuilder/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/easybuilder/admin/about.php');
		$this->authenticate();
		return $this->assertContains('easybuilder/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('easybuilderwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modEasyBuilder_EasyBuilderTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modEasyBuilder_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
